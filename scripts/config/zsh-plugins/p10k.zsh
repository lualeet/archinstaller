# Generated by Powerlevel10k configuration wizard on 2021-09-12 at 16:51 EEST.
...
() {
 ...
 # Separator between same-color segments on the right.
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#9b85ba'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#be92ff'
